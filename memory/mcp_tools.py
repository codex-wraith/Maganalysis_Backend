...
def register_memory_tools(mcp_instance, agent_instance):
    """Register memory management tools with the MCP server"""
    global agent
    agent = agent_instance
    
    # Register functions with MCP
    mcp_instance.tool()(get_conversation_history)
    mcp_instance.tool()(add_memory_conversation_to_context)
    mcp_instance.tool()(clear_user_memory)