...
# Do not import tool functions directly - they will be accessed via mcp.tools
...
class CipherAgent:
    ...
    async def analyze_asset(self, symbol, asset_type="stock", market="USD", interval="60min", for_user_display=False, platform="web"):
        ...
        try:
            ...
            try:
                ...
                primary_tech_data = await mcp.tools.get_technical_indicators(symbol, asset_type, interval)
                ...
                if current_price:
                    ...
                    mtf_analysis = await mcp.tools.analyze_multi_timeframe(symbol, asset_type, interval)
                    price_levels = await mcp.tools.get_price_levels(symbol, asset_type, interval)
            ...
            tech_data = await mcp.tools.get_technical_indicators(symbol, asset_type, interval)
            price_levels = await mcp.tools.get_price_levels(symbol, asset_type, interval)
    ...
    async def _fetch_real_time_price(self, symbol: str, asset_type: str, fallback_price=None):
        ...
        try:
            ...
            tech_data = await mcp.tools.get_technical_indicators(symbol, asset_type, "60min")
    ...
    async def _fetch_market_data(self, symbol, asset_type, interval):
        ...
        try:
            # Get raw market data
            market_data = await mcp.tools.get_raw_market_data(symbol, asset_type, interval)
    ...
    async def _analyze_multi_timeframe_levels(self, symbol, asset_type, current_price, main_interval, latest_atr=None):
        ...
        try:
            ...
            mtf_analysis = await mcp.tools.analyze_multi_timeframe(symbol, asset_type, main_interval)
            price_levels = await mcp.tools.get_price_levels(symbol, asset_type, main_interval)
