...
class CipherAgent:
    ...
    async def _fetch_real_time_price(self, symbol: str, asset_type: str, fallback_price=None):
        ...
        try:
            ...
            tech_data = await get_technical_indicators(symbol, asset_type, "60min")
    ...
    async def _fetch_market_data(self, symbol, asset_type, interval):
        ...
        try:
            ...
            # Get raw market data
            market_data = await get_raw_market_data(symbol, asset_type, interval)
    ...
    async def _analyze_multi_timeframe_levels(self, symbol, asset_type, current_price, main_interval, latest_atr=None):
        ...
        try:
            ...
            mtf_analysis = await analyze_multi_timeframe(symbol, asset_type, main_interval)
            price_levels = await get_price_levels(symbol, asset_type, main_interval)
